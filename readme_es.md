🇪🇸 **Español** · 🇬🇧 [English](readme_en.md) · 🇨🇳 [中文](readme_zh.md)
...
Para Gemma 4 usé **otro fork**: [https://github.com/cortexist/llama.cpp](https://github.com/cortexist/llama.cpp) (soporta turbo3 para Gemma 4).

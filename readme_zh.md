🇪🇸 [Español](readme_es.md) · 🇬🇧 [English](readme_en.md) · 🇨🇳 **中文**
...
对于 Gemma 4，我使用了**另一个分支**：[https://github.com/cortexist/llama.cpp](https://github.com/cortexist/llama.cpp)（支持 Gemma 4 的 turbo3）。
...
├── configs/
│   ├── qwythos-9b-300k.bat    # Qwythos 命令
│   └── gemma-4-26b-256k.bat   # Gemma 4 命令
├── templates/
